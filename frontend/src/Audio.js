...
const Audio = () => {
  ...
  const uploadAudio = async () => {
    try {
      ...
      const response = await axios.post('http://localhost:9091/http://127.0.0.1:5000/audio', formData, {
        headers: {
      ...
      if (response.status === 200) {
        // Login successful
        navigate('/threat_detection'); // Replace '/new-page' with your desired route
      } else {
